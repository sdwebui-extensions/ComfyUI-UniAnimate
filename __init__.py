...
# snapshot_download('iic/unianimate', local_dir=os.path.join(now_dir,"UniAnimate","checkpoints"))
...
NODE_CLASS_MAPPINGS = {
    "UniAnimatePoseAlignNode":PoseAlignNode, 
    "UniAnimateNode":UniAnimateNode,
    "UniAnimateLoadImagePath":LoadImagePath,
    "UniAnimatePreViewVideo":PreViewVideo,
    "UniAnimateLoadVideo":LoadVideo
}

# A dictionary that contains the friendly/humanly readable titles for the nodes
NODE_DISPLAY_NAME_MAPPINGS = {
    "UniAnimatePoseAlignNode":"UniAnimatePoseAlignNode", 
    "UniAnimateNode":"UniAnimateNode",
    "UniAnimateLoadImagePath":"UniAnimateLoadImagePath",
    "UniAnimatePreViewVideo":"UniAnimatePreViewVideo",
    "UniAnimateLoadVideo":"UniAnimateLoadVideo"
}
